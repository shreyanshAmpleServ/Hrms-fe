...
export const fetchbranch = createAsyncThunk(
    ...
    async (datas, thunkAPI) => {
        try {
            ...
            const response = await apiClient.get("/v1/branch-master",{params});
...
export const addbranch = createAsyncThunk(
    ...
    async (branchData, thunkAPI) => {
        try {
            const response = await apiClient.post("/v1/branch-master", branchData);
            return response.data;
        } catch (error) {
            return thunkAPI.rejectWithValue(
...
export const updatebranch = createAsyncThunk(
    ...
    async ({ id, branchData }, thunkAPI) => {
        try {
            const response = await apiClient.put(`/v1/branch-master/${id}`, branchData);
            return response.data;
        } catch (error) {
...
export const deletebranch = createAsyncThunk(
    ...
    async (id, thunkAPI) => {
        try {
            const response = await apiClient.delete(`/v1/branch-master/${id}`);
            return {
                data: { id },
