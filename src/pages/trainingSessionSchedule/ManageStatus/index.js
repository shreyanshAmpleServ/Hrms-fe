...
import { updatetrainingSession } from "../../../redux/trainingSessionSchedule";
...
const ManageStatus = ({ open, setOpen, selected }) => {
  ...
  const {
    ...
    defaultValues: {
      training_status: selected?.training_status || "Pending",
  ...
  useEffect(() => {
    if (selected) {
      setValue("training_status", selected.training_status);
