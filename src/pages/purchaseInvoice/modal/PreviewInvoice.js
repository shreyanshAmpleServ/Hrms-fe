...
const PreviewPurchaseOrder = ({ order, setOrder, formatNumber }) => {
  ...
  React.useEffect(() => {
    const offcanvasElement = document.getElementById(
      "offcanvas_preview_purchase_invoice",
    );
    if (offcanvasElement) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="position-relative offcanvas-body"
      >
        <form>
          <div>
            <span
            ...
            <div className="text-end mb-3">
              ...
              >
                <div className="">
                  {" "}
                  <span className="fw-semibold h5">Code : </span>{" "}
                  <span className="text-primary h4">#{order?.order_code}</span>{" "}
                </div>
                <div className="">
                  {" "}
