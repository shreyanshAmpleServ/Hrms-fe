  ...
  React.useEffect(() => {
    if (timeSheet) {
      reset({
        ...
        leave_type_id: timeSheet.leave_type_id || "",
        leave_days: timeSheet.leave_days || "",
        encashment_date: timeSheet.encashment_date || new Date().toISOString(),
        encashment_amount: timeSheet.encashment_amount || "",
    ...
    <>
      ...
      >
        <div className="offcanvas-header border-bottom">
          <h4>{timeSheet ? "Update " : "Add New "} Time Sheet</h4>
          <button
            type="button"
