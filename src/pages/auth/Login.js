    ...
    <div className="account-content">
      ...
      <div className=" account-content d-flex  flex-column flex-lg-row flex-wrap w-100 vh-100 overflow-hidden account-bg-0 bg-white">
               ...
               >
                 ...
                 <div   className="position-absolute z-0 m-5 rounded-5  bg-white  opacity-25  "style={{ height: "85%" ,width:"80%", }} ></div>
                 <div
               ...
               <div
           className="d-flex custom-width align-items-center justify-content-center flex-wrap vh-100 overflow-auto p-4  bg-opacity-25"  >
      <div className=' rounded ' style={{ border:"2px light black", transform: 'scale(1.1)', padding:"40px",boxShadow:"10px black"}}>
<form className="flex-fill" onSubmit={handleLogin}>
            <div className="mx-auto mw-450">
              ...
              <div className="text-center">
                  <p className="fw-medium text-gray">Copyright © 2025 - HRMS</p>
              </div>
