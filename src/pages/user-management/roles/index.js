...
const RolesPermissions = () => {
  ...
  return (
    <div className="page-wrapper">
      <Helmet>
        <title>DCC HRMS - Roles & Permissions</title>
        <meta
          name="Roles_&_Permissions"
          content="This is Roles_&_Permissions page of DCC HRMS."
        />
      </Helmet>
      <div className="content">
        {(errorPermission || error) && (
          <FlashMessage
            ...
            onClose={() =>
              dispatch(error ? clearMessages() : clearMessagesPermission())
            }
          />
        )}
        {(success || successPermission) && (
          <FlashMessage
            ...
            onClose={() =>
              dispatch(success ? clearMessages() : clearMessagesPermission())
            }
          />
        )}
