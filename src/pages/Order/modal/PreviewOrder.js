          ...
          <div>
            ...
            <div className="text-end mb-3">
              <div className="fw-bold h1">
                {" "}
                Order{" "}
                <span className="text-primary h3">#{order?.order_code}</span>
              </div>
              <div
                className=" text-start"
                style={{ width: "27%", marginLeft: "73%" }}
              >
                <div className="">
                  {" "}
                ...
                <div className="">
                  {" "}
                  <span className="fw-semibold h5">Order Date : </span>
                  <span>
            ...
            <div className="row">
              ...
              >
                <div className="">
                  ...
                  <div> {order?.order_vendor?.name || ""}</div>
                  <div>{` ${order?.order_vendor?.billing_street || ""},${order?.order_vendor?.billing_city || ""}, ${order?.order_vendor?.state?.name || ""}, ${order?.order_vendor?.country?.name || ""}, ${order?.order_vendor?.billing_zipcode || ""}`}</div>
                </div>
              </div>
              {/* <div className="col-md-4 ">
            <div className="">
