                            ...
                            >
                              <div>
                                <p>
                                  ...
                                  operating an online payments system in the
                                  majority of countries that support online
                            ...
                            >
                              <div>
                                <p>
                                  ...
                                  adipiscing elit. Nulla dapibus magna sit amet
                                  risus dictum iaculis. Donec fermentum
                                  fermentum tincidunt. Pellentesque mauris elit,
                                  viverra non eros in, condimentum vulputate
                                  libero. Phasellus eu orci et felis maximus
                                  posuere.
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="row  gy-3">
                              <div className="col-sm-5">
                                <div className="d-flex align-items-center">
                                  <span className="border rounded d-flex align-items-center justify-content-center payment-img p-2">
                                    <ImageWithBasePath
                                      src="assets/img/icons/payment-05.svg"
                                      alt=""
                                    />
                                  </span>
                                  <div className="ms-2">
                            ...
                            <div className="row  gy-3">
                              <div className="col-sm-5">
                                <div className="d-flex align-items-center">
                                  <span className="border rounded d-flex align-items-center justify-content-center payment-img p-2">
                                    <ImageWithBasePath
                                      src="assets/img/icons/payment-06.svg"
                                      alt=""
                                    />
                                  </span>
                                  <div className="ms-2">
                            ...
                            <div className="row  gy-3">
                              <div className="col-sm-5">
                                <div className="d-flex align-items-center">
                                  <span className="border rounded d-flex align-items-center justify-content-center payment-img p-2">
                                    <ImageWithBasePath
                                      src="assets/img/icons/payment-07.svg"
                                      alt=""
                                    />
                                  </span>
                                  <div className="ms-2">
                            ...
                            <div className="row  gy-3">
                              <div className="col-sm-5">
                                <div className="d-flex align-items-center">
                                  <span className="border rounded d-flex align-items-center justify-content-center payment-img p-2">
                                    <ImageWithBasePath
                                      src="assets/img/icons/payment-08.svg"
                                      alt=""
                                    />
                                  </span>
                                  <div className="ms-2">
                            ...
                            <div className="row  gy-3">
                              <div className="col-sm-5">
                                <div className="d-flex align-items-center">
                                  <span className="border rounded d-flex align-items-center justify-content-center payment-img p-2">
                                    <ImageWithBasePath
                                      src="assets/img/icons/payment-09.svg"
                                      alt=""
                                    />
                                  </span>
                                  <div className="ms-2">
                            ...
                            <div className="row  gy-3">
                              <div className="col-sm-5">
                                <div className="d-flex align-items-center">
                                  <span className="border rounded d-flex align-items-center justify-content-center payment-img p-2">
                                    <ImageWithBasePath
                                      src="assets/img/icons/payment-10.svg"
                                      alt=""
                                    />
                                  </span>
                                  <div className="ms-2">
