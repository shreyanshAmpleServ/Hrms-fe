...
import { clearMessages, deleteresume_upload, fetchresume_upload } from "../../redux/resumeUpload";
...
const ResumeUpload = () => {
    ...
    const handlePageChange = ({ currentPage, pageSize }) => {
        ...
        dispatch(fetchresume_upload({ search: searchText, page: currentPage, size: pageSize }));
    };
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                ...
                <meta name="DepanrtmentList" content="This is resume_upload page of DCC CRMS." />
            </Helmet>
