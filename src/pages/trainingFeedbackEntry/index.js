...
const TrainingFeedbackEntry = () => {
  ...
  const [selectedtrainingFeedback, setSelectedtrainingFeedback] =
    useState(null);
  ...
  const { trainingFeedback, loading } = useSelector(
    (state) => state.trainingFeedback || {},
  );
