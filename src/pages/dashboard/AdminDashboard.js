...
const AdminDashboard = () => {
    ...
    const barData = {
        labels: ["HR", "Marketing", "Accounting", "Development", "Marketing", "Accounting", "Design"],
        datasets: [
          {
            label: "Employees",
              ...
              <div className="page-header mb-0">
                <div className="row align-items-center">
                  <div className="col-sm-4">
                    <h3 className="page-title fw-bold mb-0" >Admin Dashboard</h3>
                  </div>
              ...
              {/* /Page Header */}
                ...
                <div className="row align-items-center">
                  <div className="col-sm-6">
                    <ul className="contact-breadcrumb" style={{marginTop:"-3px" , fontSize:"13px"}}>
                      <li>
                ...
                <div className="card-body pb-2">
                  <div className="d-flex align-items-center justify-content-between flex-wrap">
                    <div className="d-flex align-items-center mb-2">
                      ...
                      <div>
                        <h4 className="mb-2 text-capitalize">Welcome Back , Admin</h4>
                        <p style={{fontSize:"14px"}} className="mb-0 text-capitalize">You have 21 Pending Approvals & 14 Leave Requests</p>
                      </div>
                    </div>
        ...
        {numberData.map((item, i) => (
          <Col key={i} md={6} lg={3} className="mb-3 h-100">
            <Card className="shadow-lg">
              <Card.Body>
                <div className={`p-2 text-center rounded-circle ${item.color} h-25 w-25`}><i className={`ti ${item.icon}`} /></div>
                <h3 className="small h5 my-2 text-muted">
                  {item.title}
                </h3>
                <div className="d-flex gap-2  mb-3">
                <h5>{item.value}</h5>
                <small className="text-success">{item.status}</small>
                </div>
        ...
        <Col md={6}>
          <Card className="shadow-sm">
            <Card.Body>
              ...
              <Doughnut data={doughnutData} options={Doughnutptions} />
            </Card.Body>
          </Card>
        </Col>
        <Col md={6}>
