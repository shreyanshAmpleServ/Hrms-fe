      ...
      <div className="row d-flex">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <span className="d-flex justify-content-between">
                        ...
                        <span className="fw-bolder">- 59%</span>
                      </span>{" "}
                    </li>
                    <li>
                      <span className="d-flex justify-content-between">
                        <span>
                          <span className="badge rounded-circle bg-dark me-2">
                            &nbsp;
                          </span>
                          Late
                        </span>
                        <span className="fw-bolder">- 21%</span>
                      </span>{" "}
                    </li>
                    <li>
                      <span className="d-flex justify-content-between">
                        <span>
                          <span className="badge rounded-circle bg-warning text-dark me-2">
                            &nbsp;
                          </span>
                          Permission
                        </span>
                        <span className="fw-bolder">- 12%</span>
                      </span>
                    </li>
                    <li>
                      <span className="d-flex justify-content-between">
                        <span>
                          {" "}
                          <span className="badge rounded-circle bg-danger me-2">
                            &nbsp;
                          </span>
                          Absent
                        </span>
                        <span className="fw-bolder">- 15%</span>
                      </span>{" "}
                    </li>
                  </ul>
                </div>
        ...
        <div className="col-lg-6 d-flex min-vh-50">
          <div className="card shadow-lg w-100">
            <div className="card-body d-flex flex-column">
              <div className="row">
                <h5 className="mb-3 col-8 mt-2 fw-semibold">Check-in/Out</h5>
                <div className="col-2">
                  <Link
                    to="#"
                    className="btn btn-group border text-nowrap p-1 "
