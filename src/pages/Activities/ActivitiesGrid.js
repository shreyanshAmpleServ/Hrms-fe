    ...
    <>
      <div className="d-flex flex-wrap">
        {data.map((activity, index) => (
          <div
            className={`col-xxl-4 col-xl-4 col-md-6 ${index % 3 === 1 ? "px-xl-1 py-xl-2 p-md-2" : " p-xl-2 p-md-2"}`}
                ...
                <div className="d-flex align-items-center justify-content-between  mb-3">
                  <div className="d-flex align-items-center">
                    <img
                      ...
                      className="border  shadow-4  rounded-circle"
                      alt="img"
                    />
                    <div className="">
                      <h6>
      ...
      <ActivitiesModal
        setActivity={setSelectedContact}
        activity={selectedContact}
      />
