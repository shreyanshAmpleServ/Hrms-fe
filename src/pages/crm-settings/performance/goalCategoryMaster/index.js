...
import { clearMessages, deletegoal_category, fetchgoal_category } from "../../../../redux/goalCategoryMaster";
...
const GoalCategoryMaster = () => {
    ...
    const handlePageChange = ({ currentPage, pageSize }) => {
        ...
        dispatch(fetchgoal_category({ search: searchText, page: currentPage, size: pageSize }));
    };
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                ...
                <meta name="DepanrtmentList" content="This is goal_category page of DCC CRMS." />
            </Helmet>
