...
import { clearMessages, deletereview_template, fetchreview_template } from "../../../../redux/reviewTemplateMaster";
...
const ReviewTemplateMaster = () => {
    ...
    const handlePageChange = ({ currentPage, pageSize }) => {
        ...
        dispatch(fetchreview_template({ search: searchText, page: currentPage, size: pageSize }));
    };
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                ...
                <meta name="DepanrtmentList" content="This is review_template page of DCC CRMS." />
            </Helmet>
