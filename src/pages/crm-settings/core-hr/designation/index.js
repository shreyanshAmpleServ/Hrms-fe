...
import { clearMessages, deletedesignation, fetchdesignation } from "../../../../redux/designation";
...
const DesignationList = () => {
    ...
    const columns = [
        {
            ...
            render: (text, record) => (
                <Link to={`#`}>{record.designation_name}</Link>
            ),
    ...
    const handlePageChange = ({ currentPage, pageSize }) => {
        ...
        dispatch(fetchdesignation({ search: searchText, page: currentPage, size: pageSize }));
    };
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                ...
                <meta name="designation" content="This is designation page of DCC CRMS." />
            </Helmet>
