...
import { clearMessages, deletegrievance_type, fetchgrievance_type } from "../../../../redux/grievanceTypeMaster";
...
const GrievanceTypeMaster = () => {
    ...
    const handlePageChange = ({ currentPage, pageSize }) => {
        ...
        dispatch(fetchgrievance_type({ search: searchText, page: currentPage, size: pageSize }));
    };
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                ...
                <meta name="DepanrtmentList" content="This is grievance_type page of DCC CRMS." />
            </Helmet>
                            ...
                            <div className="row align-items-center">
                                <div className="col-8">
                                    <h4 className="page-title">
                                        Grievance Type Master                                        <span className="count-title">
