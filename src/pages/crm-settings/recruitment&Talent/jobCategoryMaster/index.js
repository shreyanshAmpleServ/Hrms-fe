...
import { clearMessages, deletejob_category, fetchjob_category } from "../../../../redux/jobCategoryMaster";
...
const JobCategoryMaster = () => {
    ...
    const { job_category, loading, error, success } = useSelector(
    ...
    const handlePageChange = ({ currentPage, pageSize }) => {
        ...
        dispatch(fetchjob_category({ search: searchText, page: currentPage, size: pageSize }));
    };
    ...
    const deleteData = () => {
        if (selectedIndustry) {
            dispatch(deletejob_category(selectedIndustry.id));
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                ...
                <meta name="DepanrtmentList" content="This is job_category page of DCC CRMS." />
            </Helmet>
