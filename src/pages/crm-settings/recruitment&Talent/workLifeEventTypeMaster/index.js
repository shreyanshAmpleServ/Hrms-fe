...
import { clearMessages, deletework_life, fetchwork_life } from "../../../../redux/workLifeEventTypeMaster";
...
const WorkLifeEventTypeMaster = () => {
    ...
    const columns = [
        {
            ...
            render: (_text, record) => (
                <Link to={`#`}>{record.event_type_name}</Link>
            ),
    ...
    React.useEffect(() => {
        setPaginationData({
            currentPage: work_life?.currentPage,
            totalPage: work_life?.totalPages,
            totalCount: work_life?.totalCount,
            pageSize: work_life?.size
        })
    }, [work_life])
    ...
    const handlePageChange = ({ currentPage, pageSize }) => {
        ...
        dispatch(fetchwork_life({ search: searchText, page: currentPage, size: pageSize }));
    };
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                ...
                <meta name="DepanrtmentList" content="This is work_life page of DCC CRMS." />
            </Helmet>
...
export default WorkLifeEventTypeMaster;
