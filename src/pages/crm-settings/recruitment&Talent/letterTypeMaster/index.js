...
import { clearMessages, deletelatter_type, fetchlatter_type } from "../../../../redux/letterType";
...
const LetterTypeMaster = () => {
    ...
    const columns = [
        {
            ...
            render: (_text, record) => (
                <Link to={`#`}>{record.letter_name}</Link>
            ),
    ...
    const handlePageChange = ({ currentPage, pageSize }) => {
        ...
        dispatch(fetchlatter_type({ search: searchText, page: currentPage, size: pageSize }));
    };
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                ...
                <meta name="DepanrtmentList" content="This is latter_type page of DCC CRMS." />
            </Helmet>
