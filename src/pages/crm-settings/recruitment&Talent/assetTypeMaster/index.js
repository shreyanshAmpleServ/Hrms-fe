...
import { clearMessages, deleteassets_type, fetchassets_type } from "../../../../redux/assetType";
...
const AssetTypeMaster = () => {
    ...
    const { assets_type, loading, error, success } = useSelector(
    ...
    const handlePageChange = ({ currentPage, pageSize }) => {
        ...
        dispatch(fetchassets_type({ search: searchText, page: currentPage, size: pageSize }));
    };
    ...
    const deleteData = () => {
        if (selectedIndustry) {
            dispatch(deleteassets_type(selectedIndustry.id));
            // navigate(`/assets_type`);
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                ...
                <meta name="DepanrtmentList" content="This is assets_type page of DCC CRMS." />
            </Helmet>
