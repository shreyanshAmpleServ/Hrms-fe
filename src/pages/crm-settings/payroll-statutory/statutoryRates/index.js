...
import { clearMessages, deletestatutory_rates, fetchstatutory_rates } from "../../../../redux/statutoryRate";
...
const StatutoryRates = () => {
    ...
    const handlePageChange = ({ currentPage, pageSize }) => {
        ...
        dispatch(fetchstatutory_rates({ search: searchText, page: currentPage, size: pageSize }));
    };
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                ...
                <meta name="DepanrtmentList" content="This is statutory_rates page of DCC CRMS." />
            </Helmet>
