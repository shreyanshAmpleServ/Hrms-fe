...
import { clearMessages, deleteprovident_fund, fetchprovident_fund } from "../../../../redux/providentFund";
...
const ProvidentFund = () => {
    ...
    const { provident_fund, loading, error, success } = useSelector(
    ...
    const handlePageChange = ({ currentPage, pageSize }) => {
        ...
        dispatch(fetchprovident_fund({ search: searchText, page: currentPage, size: pageSize }));
    };
    ...
    const deleteData = () => {
        if (selectedIndustry) {
            dispatch(deleteprovident_fund(selectedIndustry.id));
            // navigate(`/provident_fund`);
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                ...
                <meta name="DepanrtmentList" content="This is provident_fund page of DCC CRMS." />
            </Helmet>
