...
import { clearMessages, deletepay_component, fetchpay_component } from "../../../../redux/pay-component";
...
const Paycomponent = () => {
    ...
    const handlePageChange = ({ currentPage, pageSize }) => {
        ...
        dispatch(fetchpay_component({ search: searchText, page: currentPage, size: pageSize }));
    };
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                ...
                <meta name="DepanrtmentList" content="This is pay_component page of DCC CRMS." />
            </Helmet>
