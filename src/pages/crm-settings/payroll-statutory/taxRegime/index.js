...
import { clearMessages, deletetax_relief, fetchtax_relief } from "../../../../redux/taxRelief";
...
const TaxRelirf = () => {
    ...
    const handlePageChange = ({ currentPage, pageSize }) => {
        ...
        dispatch(fetchtax_relief({ search: searchText, page: currentPage, size: pageSize }));
    };
    ...
    return (
        <div className="page-wrapper">
            <Helmet>
                ...
                <meta name="DepanrtmentList" content="This is tax_relief page of DCC CRMS." />
            </Helmet>
