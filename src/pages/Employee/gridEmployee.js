    ...
    return (
        <>
                            ...
                            <div className="card-body">
                                <div className="d-flex align-items-center justify-content-between mb-3">
                                    <div className="d-flex align-items-center">
                                        ...
                                        >
                                            <ImageWithDatabase
                                                src={contact.profile_pic || 'assets/img/profiles/default-avatar.jpg'}
                                                alt="img"
                                            />
                                        </Link>
                                        <div>
                                            ...
                                            <p style={{lineHeight:"1.2"}} className="text-default">
                                               <div> {contact.hrms_employee_designation?.designation_name || 'N/A'}</div>
                                              <span style={{fontWeight:500}} > ({contact.hrms_employee_department?.department_name || 'N/A'}) </span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="d-block">
                                    <div className="d-flex flex-column mb-3">
                                     ...
                                     {contact?.hrms_employee_address?.map((item, ind)=>(ind ===0 &&   <p className="text-default d-inline-flex align-items-center mb-1">
            ...
            <div className="load-btn text-center pb-4">
                ...
                <ManageEmpModal setEmployeeData={setSelectedContact} employeeData={selectedContact} />
