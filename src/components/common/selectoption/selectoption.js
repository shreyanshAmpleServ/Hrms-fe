...
export const ModuleOptions = [
  { path: route.dashboard, label: "Dashboard", value: "Dashboard" },
  { path: route.employee, label: "Employee", value: "Employee" },
  { path: route.attendance, label: "Attendance", value: "Attendance" },
  { path: route.leaveApplications, label: "Leave", value: "Leave" },
  { path: route.monthlyPayroll, label: "Payroll", value: "Payroll" },
