...
export const ModuleOptions = [
  ...
  { path: route.employee, label: "Employee", value: "Employee" },
  { path: route.attendance, label: "Attendance", value: "Attendance" },
  { path: route.leave, label: "Leave", value: "Leave" },
  { path: route.payroll, label: "Payroll", value: "Payroll" },
  { path: route.statutory, label: "Statutory", value: "Statutory" },
  { path: route.CostCenter, label: "Cost Center", value: "Cost Center" },
  { path: route.payComponent, label: "Pay Component", value: "Pay Component" },
  ...
  { path: route.candidates, label: "Candidates", value: "Candidates" },
  { path: route.interviews, label: "Interviews", value: "Interviews" },
